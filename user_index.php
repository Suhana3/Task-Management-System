      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="user_index.php" data-content="dashboard" id="logout_link">
                <span class="menu-title">Dashboard</span>
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="user_task.php" data-content="user_task" id="manage_task">
                <span class="menu-title">Tasks</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="user_leave.php" data-content="user_leave" id="apply_leave">
                <span class="menu-title">Apply Leave</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="user_leave_status.php" data-content="user_leave_status" id="leave_status">
              ...
              <div class="col-md-6 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Completed Tasks <i class="mdi mdi-alarm-check float-right"></i>
                    <br>
                      <h2 style="font-weight: bolder;">
                        <?php
                          $sql="SELECT COUNT(*) as total_count FROM tasks WHERE uid=$_SESSION[uid] AND status='Completed'";
                ...
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <br>
                      <h2 style="font-weight: bolder;">
                        <?php
                          $sql="SELECT COUNT(*) as total_count FROM tasks WHERE uid=$_SESSION[uid] AND (status='In-progress' OR status='Not started')";
                          $result=mysqli_query($conn,$sql);
                          if($result){
                            $row=mysqli_fetch_assoc($result);
